  ...
  return (
    <thead className="dark:bg-gray-800 bg-white border-b border-gray-700">
      <tr className="text-center md:text-left">
        ...
        <th className="hidden sm:table-cell px-1 md:px-4 py-2 text-xs md:text-sm text-gray-700 dark:text-gray-500 w-[8rem]">Amount</th>
        <th className="hidden sm:table-cell px-1 md:px-4 py-2 text-xs md:text-sm text-gray-700 dark:text-gray-500 w-[8rem]">Price</th>
