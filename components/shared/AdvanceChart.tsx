    ...
    <div className="flex px-1 lg:px-4 gap-1 lg:gap-4">
      <div className="block md:flex w-full px-1 lg:px-4 gap-1 lg:gap-4">
        <div className="block xs:flex md:block justify-center gap-4">
          <div className="dark:bg-gray-800 bg-white shadow-md border border-gray-200 w-[320px] flex justify-center mx-auto px-2 rounded-xl p-4 mt-4">
            <CurrentBalance />
          </div>
          ...
          <div className=" dark:bg-gray-800 bg-white shadow-md border border-gray-200 w-[320px]  px-2 rounded-xl p-4 mt-4">
            <CurrentHoldings />
          </div>
